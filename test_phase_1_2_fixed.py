...
def test_exposure_map():
    ...
    print(f"[OK] Exposed entities: {list(exp_map.keys())}")
    print(f"[OK] User REST path: {user_config['rest_path']}")
    print(f"[OK] User operations: {user_config['operations']}")
    print(f"[OK] User id_field: {user_config['id_field']}")
    print()
...
def test_crud_helpers():
    ...
    print("[OK] HTTP method mappings correct")
    print("[OK] Path suffix mappings correct")
    print("[OK] Status code mappings correct")
    print("[OK] Schema name derivation correct")
    print()
...
def test_writable_attributes():
    ...
    print(f"[OK] Writable attributes (no readonly): {[a.name for a in get_writable_attributes(entity)]}")
    print(f"[OK] Writable attributes (id readonly): {[a.name for a in get_writable_attributes(entity, ['id'])]}")
    print()
